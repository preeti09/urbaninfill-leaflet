...
//(Bhavana )testing route
Route::get('/api_test', 'homeController@test');
Route::get('/data/get', 'homeController@responseAjax');
Route::get('/getGeoKey', 'homeController@getGeoKey');
Route::get('/new_api', 'homeController@NewApi');
...
//(bhavana) route get boundary
Route::get("getBoundary",'AjaxController@getBoundary');
